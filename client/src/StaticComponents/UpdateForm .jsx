    ...
    <div className="fixed inset-0 flex items-center justify-center bg-gray-500 bg-opacity-75 lg:mt-[44px]">
      <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-4xl">
        ...
        <div className="flex justify-end">
          <button className="mr-2 px-4 py-2 bg-red-500 text-white rounded hover:bg-red-400" onClick={onClose}>Cancel</button>
          <button className="px-4 py-2 bg-yellow-500 text-white rounded hover:bg-yellow-400" onClick={handleUpdate}>Update</button>
        </div>
      </div>
    </div>
  );
